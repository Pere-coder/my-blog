...
export default function Weatherdisplay() {
  ...
  if (loading) {
    ...
    return  <div className='flex flex-col mx-auto mt-10 w-[300px] md:w-[700px] p-5 h-[300px] md:h-[400px] rounded-md bg-blue-500 bg-url'>
                ...
                <div className='text-red-500 absolute text-[15px] mt-[400px] w-[300px] bg-black/50 p-2 rounded-md'><div className='m-5 flex justify-center items-center hover:cursor-pointer '><ImWarning size={20}/></div>{error}.......
