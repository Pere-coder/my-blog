...
export default function Weatherdisplay() {
  ...
  const fetchWeather = (e) => {
    ...
    return (
      <div className="bg-[url('../public/weather.jpg')] bg-no-repeat bg-cover flex flex-col mx-auto mt-10 w-[300px] md:w-[700px] p-5 h-[300px] md:h-[400px] rounded-md" >
      <div className='flex flex-col bg-black/40 '/>
         ...
         {error && <div className='flex flex-col justify-center items-center text-center mt-16 text-[20px] md:text-[30px] text-red-500'><ImWarning size={30}/>{error}</div>}
