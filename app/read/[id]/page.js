...
const Blogdetail = () => {
    ...
    if (!data) {
        return <div> <Navbar/><div className="flex justify-center items-center mt-10 h-[500px] font-roboto">Loading...</div><Footer/></div>;
      }
        ...
        <div className="bg-gray-100">
            ...
            <div className="flex flex-col justify-center items-center mt-10">
                <div className="shadow-2xl bg-white w-[300px]  md:w-[700px] lg:w-[900px] text-black justify-center items-center text-center rounded-md">
                    ...
                    <span className="mt-5 font-roboto">By - {data.firstname}    {data.date}</span>
                    <hr className="mt-3"/>
                    ...
                    <p className="mt-7 text-[10px] md:text-[20px] p-5 font-roboto">{data.blog}</p>
                    <Like/>
